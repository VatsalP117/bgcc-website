export default function Services() {
  return (
    <div className="flex flex-col items-center p-6 md:p-12 lg:p-16 xl:p-20 gap-8 md:gap-16 lg:gap-20">
      {/* Section 1 */}
      <div className="flex flex-col-reverse lg:flex-row lg:justify-between mb-8 md:mb-12 lg:mb-16 xl:mb-20">
        ...
        <div className="flex flex-row items-center justify-center md:w-1/2 mt-7 md:mt-0 mb-3">
          <img
      ...
      <div className="flex flex-col-reverse md:flex-row-reverse md:justify-between mb-8 md:mb-12 lg:mb-16 xl:mb-20">
        ...
        <div className="flex flex-row items-center  md:w-1/2 mt-7 md:mt-4 mb-3">
          <img
